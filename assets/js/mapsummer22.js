...
function checkinfo(e) {
    if (!localStorage.getItem('Mapverssummer22') || !(localStorage.Mapverssummer22 === "1.0")) {
        localStorage.Mapverssummer22 = "1.0";
...
L.tileLayer('media/tilessummer22/{z}/{x}/{y}.jpg', {
...
loadmarker(listteleport,Teleport,"teleport",langue.cat02,"tpsum22");
loadmarker(listlumen,Lumen,"lumen",langue.cat116,"lumen","lumen");
loadmarker(listlampe,Lampe,"lampe",langue.cat117);
loadmarker(listpeche,Peche,"peche",langue.cat94,"pechesum22");
loadmarker(listquete,Quete,"quete",langue.cat118,"quetesum22","quetesum22");
loadmarker(listsucces,Succes,"succes",langue.cat46,"successum22","successum22");
loadmarker(listpano,Pano,"pano",langue.cat03,"panosum22","panosum22");
...
loadmarker(listcordi,Cordi,"cordi",langue.cat04,"ocsum22","cordisum22");
loadmarker(listcdelic,Cdelic,"cdelic",langue.cat05,"dcsum22","cdelicsum22");
loadmarker(listcprec,Cprec,"cprec",langue.cat06,"pcsum22","cprecsum22");
loadmarker(listcluxe,Cluxe,"cluxe",langue.cat07,"lcsum22","cluxesum22");
loadmarker(listcdefi,Cdefi,"cdefi",langue.cat08,"defisum22","cdefisum22");
loadmarker(listcfee,Cfee,"cfee",langue.cat09,"cfeesum22","cfeesum22");
